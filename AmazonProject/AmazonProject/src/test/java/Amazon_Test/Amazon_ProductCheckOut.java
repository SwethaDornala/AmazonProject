...
public class Amazon_ProductCheckOut extends LaunchQuit {
	...
	public void ProductCheckoutProcess() throws EncryptedDocumentException, IOException, InterruptedException
	{
	   ...
	   Assert.assertTrue(a5.CheckDeliveryAddressSelection());
	    ...
	    Thread.sleep(10000);
	    Assert.assertTrue(a5.CheckPaymentMethodSelection());
	    a5.UseThisPaymentMethod();
	    Thread.sleep(20000);
	    System.out.println(a5.ValidateProductInOrderReview());
	    if(a5.ValidateProductInOrderReview().length()>0)
	    {
	    	OrderReviewProductCheck=true;
	    }
	    Assert.assertTrue(OrderReviewProductCheck);
	    Thread.sleep(2000);
