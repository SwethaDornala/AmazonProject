...
public class Amazon_SelectEachPaymentMethod extends LaunchQuit {
	
@Test
	
	public void SelectEachPaymentMethod() throws EncryptedDocumentException, IOException, InterruptedException
	{
	   ...
	   // Thread.sleep(10000);
	    //Assert.assertTrue(a5.CheckDeliveryAddressSelection());
	    a5.UseThisAddress();
	    Thread.sleep(20000);
	    a5.SelectCreditDebitcardPaymentMethod();
	    Thread.sleep(3000);
	    a5.SelectUPIAppsPaymentMethod();
	    Thread.sleep(3000);
	    a5.SelectEMIPaymentMethod();
	    Thread.sleep(3000);
	    a5.SelectCashOnDeliveryPaymentMethod();
	    Thread.sleep(3000);
