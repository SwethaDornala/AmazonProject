...
public class Amazon_SortSearchResults extends LaunchQuit {
	
	@Test
	public void Sort_WithMultipleOptions() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		a2.Sort_products_Featured();
		Thread.sleep(2000);
		a2.Sort_products_LowToHighPrice();
		Thread.sleep(2000);
		a2.Sort_products_HighToLowPrice();
		Thread.sleep(2000);
		a2.Sort_products_AvgCustomerRating();
		Thread.sleep(2000);
		a2.Sort_products_NewArrivals();
